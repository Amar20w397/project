...
<head>
    ...
    <style>
        ...
        .confirmation-box {
            position: fixed;
            /* Menempatkan kotak konfirmasi secara tetap pada halaman */
            top: 0;
            left: 0;
            width: 100%;
            height: 100%;
            ...
            display: none;
            /* Kotak konfirmasi disembunyikan secara default */
            justify-content: center;
            /* Posisi konten secara horizontal di tengah kotak */
            align-items: center;
            /* Posisi konten secara vertikal di tengah kotak */
        }
        ...
        .confirmation-content {
            ...
            padding: 20px;
            /* Jarak antara konten dan batas konten */
            border-radius: 8px;
            /* Sudut sudut elemen */
            display: flex;
            /* Mengatur tata letak konten menjadi flexbox */
            flex-direction: column;
            /* Menata konten menjadi kolom */
            align-items: center;
            /* Posisi konten secara vertikal di tengah */
        ...
        .confirmation-content button {
            ...
            /* Sudut sudut tombol */
            cursor: pointer;
            /* Menampilkan kursor tangan saat diarahkan ke tombol */
        ...
        .confirm-yes {
            ...
            /* Warna latar belakang untuk tombol 'Yes' */
        }

        /* Gaya untuk tombol 'No' dalam kotak konfirmasi */
        .confirm-no {
            background-color: #ff4d00;
            /* Warna latar belakang untuk tombol 'No' */
        }

        /* Gaya untuk tombol logout */
        .logout-btn {
            padding: 10px 20px;
            /* Ukuran padding tombol logout */
            font-size: 16px;
            /* Ukuran font tombol logout */
            color: #000;
            /* Warna teks tombol logout */
            border: none;
            /* Tanpa garis batas */
            border-radius: 4px;
            /* Sudut sudut tombol logout */
            cursor: pointer;
            /* Menampilkan kursor tangan saat diarahkan ke tombol logout */
            transition: background-color 0.3s ease;
            /* Transisi perubahan warna latar belakang */
            margin-bottom: 20px;
            /* Jarak bawah antara tombol logout dan konten di atasnya */
        }
    </style>
</head>
...
<body>
    ...
    <header>
        ...
        <nav>
            <div class="rumah">
                <a href="belum_tentu.html"><img src="fotoAceh.png" alt=""></a>
            </div>
            <ul>
                <li><a href="beranda.php" target="_self">HOME</a></li>
                <li><a href="belum_tentu.php" target="_self">SHOP</a></li>
                <li><a href="#kontak" target="_self">CONTACT</a></li>
    ...
    <main>
        ...
        <div class="gambar-container">
            <img src="backkk.png" alt="" width="1200px">
        </div>
        <div class="kotakdlmgambar">
            ...
            <a href="belum_tentu.html"><button class="tombol">Shop Now</button>
            </a>
        </div>
        ...
        <div class="contaa" id="kontak">
            <div class="shop">
                <h2><b>SHOP</b></h2><br>
                <a href="belum_tentu.html" target="_self">Shop Professional Art</a><br><br><br>
                <a href="shopkid.html" target="_self">Shop Kids Art</a><br><br><br>
                <a href="More_privasi.html" target="_self">Store Policy</a><br><br>
            </div>
            <div class="contact">
                <h2><b>CONTACT</b></h2><br>
                <a href="https://maps.app.goo.gl/9UbCLVpffFZisoWC9" target="_blank">Jl. Stadion H Dirmuthala, No.5 Lampinueng. Kota Banda Aceh, Kode Pos: 23125</a><br><br><br>
                <a href="acehartsstorecenter@gmail.com" target="_blank">@acehartsstorecenter</a><br><br><br>
                <a href="https://wa.me/6285173083380" target="_blank">0821-5753-8593</a><br><br>
            </div>
        </div>
    </main>
    ...
    <script>
        ...
        yesBtn.addEventListener('click', () => {
            ...
            window.location.href = 'login.html'; // Redirect ke halaman login yang sesuai
        });
